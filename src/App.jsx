...
function App() {
  ...
  const cart = (params) => {
    axios
      .post("https://payments-test.invensis.net/api/v1/carts", params, config)
  ...
  return loading ? (
    ...
    <div className="App">
      ...
      <div className="card">
        <button onClick={() => cart(bodyParameters1)}>Without Discount</button>
        <p>No discounts for this</p>
      </div>
      <div className="card">
        <button onClick={() => cart(bodyParameters2)}>With Discount</button>
      ...
      <div className="card">
        <button onClick={() => cart(bodyParameters5)}>Mahipat Test Case</button>
